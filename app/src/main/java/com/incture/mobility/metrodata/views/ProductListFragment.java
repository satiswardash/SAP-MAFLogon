...
import com.incture.mobility.metrodata.MetrodataApp;
import com.incture.mobility.metrodata.R;
...
public class ProductListFragment extends ListFragment
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //MetrodataApp app = (MetrodataApp) getActivity().getApplication();
        String[] items = ProductDataSingleton.listItems;
